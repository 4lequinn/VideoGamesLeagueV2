...
public class DetalleEquipo implements Serializable {
    ...
    @ManyToOne(optional = false)
    private Incripcion idInscripcion;
    ...
    public Incripcion getIdInscripcion() {
        return idInscripcion;
    }

    public void setIdInscripcion(Incripcion idInscripcion) {
    ...
    public String toString() {
        return "modelo.dto.DetalleEquipo[ id=" + id + " ]";
    }
