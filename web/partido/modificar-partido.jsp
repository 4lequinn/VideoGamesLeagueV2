        ...
        <body>
            ...
            <main>
                <form action="../ControladorPartido" method="POST" class="formulario" id="formulario">
                    <input hidden name="txtPartidoID" value="${partidoMod.id}">
                <!-- Grupo: Fecha -->
                <div class="formulario__grupo" id="grupo_fecha">
                    <label for="fecha" class="formulario__label">Fecha</label>
                    <div class="formulario__grupo-input">
                        <input type="date" class="formulario__input" name="fecha" id="fecha" required value="${partidoMod.fecha}">
                ...
                <div class="formulario__grupo" id="grupo_hora_inicio">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="time" class="formulario__input" name="hora_inicio" id="hora_inicio" required value="${partidoMod.horaInicio}">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                </div>
                ...
                <div class="formulario__grupo" id="grupo_hora_inicio">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="time" class="formulario__input" name="hora_termino" id="hora_termino" required value="${partidoMod.horaTermino}">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                </div>
                ...
                <div class="formulario__grupo">
                    ...
                    <select name="cboFase" id="cboFase" class="formulario__input-cbo" required>
                        ...
                        <c:forEach var="x" items="${tipoFase.rows}">
                            <c:choose>
                                <c:when test="${x.id == partidoMod.idFase.id}">
                ...
                <div class="formulario__grupo">
                    ...
                    <select name="cboLiga" id="cboLiga" class="formulario__input-cbo" required>
                        ...
                        <c:forEach var="x" items="${tipoLiga.rows}">
                            <c:choose>
                                <c:when test="${x.id == partidoMod.idLiga.id}">
                                    <option selected value="${x.id}">${x.descripcion}</option>
                                </c:when>    
                                <c:when test="${x.id != partidoMod.idLiga.id}">
                                    <option value="${x.id}">${x.descripcion}</option>
