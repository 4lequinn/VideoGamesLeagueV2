            ...
            <main>
                <form action="../ControladorUsuario" method="POST" class="formulario" id="formulario">
                    ...
                    <div class="formulario__grupo" id="grupo__apellido">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="apellido" id="apellido" placeholder="Ej. Juillet" required minlength="3" maxlength="40">
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                    ...
                    <div class="formulario__grupo" id="grupo__password">
                        ...
                        <p class="formulario__input-error">La contrase̱a tiene que ser de 4 a 12 digitos.</p>
                    </div>
