<%-- 
    Document   : newjsp
    Created on : 04-10-2021, 23:28:16
    Author     : jorge
--%>
...
<head>
    ...
    <script defer src="functions/js/navbar/theme.js"></script>
...
<body>
            ...
            <li class="nav-item">
              ...
              <g class="fa-group">
                ...
                ></path>
                    ...
                    <span class="link-text">Ligas</span>
                </a>
            </li>
    ...
    <main style="background-image: url(theme/img/videojuego/sports.png); background-size: cover; height: 100vh">
        <h1>Inicio</h1>

        <p style="color: white">
            Tuki es la plataforma oficial de competición de LVP. Como espacio de entrenamiento para los jugadores que quieren convertirse en profesionales o como rincón de juego donde ganar premios, ArenaGG está presente en decenas de países del mundo. ¡Te esperamos!.
        </p>
